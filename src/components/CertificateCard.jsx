  ...
  return (
    ...
    hover:shadow-2xl hover:shadow-white/10">
      ...
      <div className="relative p-6">
        ...
        <p className="mt-2 transform text-sm font-medium text-gray-400 transition-all duration-700 delay-75 group-hover:translate-x-2 group-hover:text-gray-300">
          {issuer}
        </p>
        <p className="mt-1 transform text-sm text-gray-500 transition-all duration-700 delay-100 group-hover:translate-x-2">
          {date}
        </p>
        <a
          href={link}
