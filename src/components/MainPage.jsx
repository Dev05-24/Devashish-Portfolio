    ...
    <>
      <div className="flex items-center justify-around m-auto h-screen">
        <div className={`content sm:w-full lg:w-2/4 p-10 m-10 text-center sm:text-left transition-all ease-in-out duration-500 transform ${isVisisble ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0"}`}>
          ...
          <a href=""><i className="fa-brands fa-linkedin text-3xl transition-transform transform hover:scale-130"></i></a>
          <a href=""><i className="fa-brands fa-github text-3xl transition-transform transform hover:scale-130"></i></a>
          <a href=""><i className="fa-brands fa-instagram text-3xl transition-transform transform hover:scale-130"></i></a>
          </div>
        </div>
